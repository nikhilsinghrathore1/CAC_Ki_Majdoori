...
const Marquee = ({text , dist}:marqueprop) => {
               // console.log(dist)
  return (
    <div className={`w-full flex gap-6 items-center f3 text-[70px] leading-none`}
    style={{ transform: `translateX(-${dist}%)` }}
    >
               <div className='flex  gap-6  px-2 items-center'>
                              <h1>{text[0]}</h1>
                              <div className='w-12 mt-[0px] h-12 rounded-full'>
               ...
               <div className='flex  gap-6  px-2 items-center'>
                              <h1>{text[1]}</h1>
                              <div className='w-12  mt-[12px] h-12 rounded-full'>
