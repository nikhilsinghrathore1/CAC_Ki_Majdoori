...
const Fifth = () => {
  return (
    <div className='w-full px-14 h-[200vh] bg-white pt-40 '>
               ...
               <div className='border-b-[1px] border-black h-[10%] px-5 overflow-hidden flex w-full relative  mt-[85px]'>
                                             <InsideImage ind={"01"} text={"Dr. Rick McCartney"} post={"CEO"}/>
                  <div className='w-full h-full bg-blue-500 absolute translate-y-[100%] z-[0] top-0 left-0'></div>
