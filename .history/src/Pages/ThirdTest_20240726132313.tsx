...
useEffect(() => {
  ...
  return (
    <div ref={mainCont} className='w-full  h-[250vh] justify-between bg-[#AEDEE0] flex items-start px-12'>
               ...
               <div className='w-[50%]   h-full pt-[85vh] pl-12'>
                              <div ref={firstCont} className=' w-[460px] origin-center ml-3  transition-all  pt-4  flex justify-between gap-4 px-10 border border-black h-[17.5%]'>
...
<path d="M4 26H60" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                              ...
                              <div ref={secondCont} className=' w-[77%] mt-8 origin-center ml-3  transition-all  pt-4  flex justify-between gap-4 px-10 border border-black h-[17.5%]'>
                                            <InsideAbout mainText={"Custom Products"} para={"We build mobile and web-based apps, platforms, and infrastructure fitted to your needs. We have an open solutions framework, so we work to fit your business, not the other way around."} svg={<svg width="100%" height="40%" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path d="M28.0003 42V52H18.0003" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                              ...
                              <div ref={thirdCont} className=' w-[77%] mt-8 origin-center ml-3  transition-all  pt-4  flex justify-between gap-4 px-10 border border-black h-[17.5%]'>
                                            <InsideAbout mainText={"Partnerships"} para={"We work with payers, providers, and pharma to help internal teams through ground-up builds, product optimizations, and streamlining data/analytics."} svg={<svg width="100%" height="40%" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path d="M28 53.2154L20.4651 51.3317C20.1594 51.2552 19.876 51.1076 19.6381 50.9008L14 46" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                              ...
                              <div ref={fourthCont} className=' w-[77%] mt-8 origin-center ml-3  transition-all  pt-4  flex justify-between gap-4 px-10 border border-black h-[17.5%]'>
                                            <InsideAbout mainText={"Security & Compliance"} para={"Not just technology experts. Health experts. We are able to navigate both stringent regulatory environments and the complexities of technology and data."} svg={<svg width="100%" height="40%" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
