  ...
  return (
    <div className='w-full h-[300vh] justify-between flex items-start px-10'>
               <div className='w-[41.9%]'>
                           ...
                           <div className='w-[35%] h-[50px] border font-semibold uppercase flex items-center gap-2 text-[15px] tracking-tight f2 justify-center'>our Solution <GoArrowUpRight/></div>
               </div>
