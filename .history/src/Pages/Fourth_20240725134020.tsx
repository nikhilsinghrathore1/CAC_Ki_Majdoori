  ...
  return (
    <div className='w-full h-[400vh] '>
               <div className='w-full flex flex-nowrap  h-[100vh] sticky top-0 '>
                              ...
                              <div className='w-full h-full bg-yellow-300  relativeflex-shrink-0 p-10'>
                              <div className='w-full flex justify-start b h-[30%] pl-10'>
                                             ...
                                             <div className='w-[20rem] h-[20rem] absolute top-[50%] '>
                                             ...
                                             <div className='w-[15rem] h-[15rem] absolute bg-red-900 top-[30%] left-[0%] '>
                                             ...
                                             <div className='w-[15rem] h-[15rem] absolute top-[30%] left-[60%] '>
