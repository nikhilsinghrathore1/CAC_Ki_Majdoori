    ...
    <div className='w-full h-[400vh] '>
               <div className='w-full flex flex-nowrap  h-[100vh] sticky top-0 '>
                              ...
                              <div className='w-full flex justify-start b h-[30%] pl-10'>
                                             ...
                                             <div className='w-full h-[70%] pl-40'>
                                                            <div className='text-[10rem] text-right w-[70%] leading-none font-semibold f5'>49%</div>
                                                            <div className=' text-center text-[2.5rem] w-[80%]  f3 leading-[3.5rem]'> <p>Expert women in tech.</p></div>
                                             </div>
                              </div>
