  ...
  return (
    <div className='w-full h-[300vh] justify-between flex items-start px-10'>
               <div className='w-[41.9%]'>
                           ...
                           <div className='w-[35%] h-[45px] mt-6 border font-semibold uppercase flex items-center gap-2 text-[15px] tracking-tight f4 justify-center'>our Solution <GoArrowUpRight/></div>
               </div>
