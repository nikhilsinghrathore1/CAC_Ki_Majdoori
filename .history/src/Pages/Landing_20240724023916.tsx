    ...
    <div className='w-full relative text-[#EEE9CC] h-[110vh] bg-[#1E1915]'>
      ...
      <div className='w-full h-full'>
        ...
        <div className='w-full h-[23%] overflow-hidden relative bg-red-50'>
          <img className='w-full h-[110vh] object-cover scale-[100%] .trsni' style={{objectPosition:"50% 30%"}} src={img[0]} alt="not showing" />
          {/* <div className='w-full h-full bg-black absolute top-[0%] '></div> */}
        </div>
        {/* second image  */}
        <div className='w-full h-[22.5%] relative overflow-hidden'>
          <img className='w-full h-[110vh] scale-[100%] origin-center transi object-cover' style={{objectPosition:"50% "}} src={img[0]} alt="not showing" />
          {/* <div className='w-full h-full bg-black absolute top-[0%] '></div> */}
        </div>
