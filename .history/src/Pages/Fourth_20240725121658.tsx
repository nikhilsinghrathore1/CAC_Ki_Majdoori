               ...
               <div className='w-full flex flex-nowrap  h-[100vh] sticky top-0 '>
                              ...
                              <div className='w-full h-full  flex-shrink-0 p-10'>
                                             <div className='w-full flex justify-start h-[30%]'>
                                                            <p className='w-[20%] text-[17px] leading-[22px] '>We’re on a mission to impact as many lives as possible and build a better company while we do it. Here’s our progress.</p>
                                             </div>
                              </div>
