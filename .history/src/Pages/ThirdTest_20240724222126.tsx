...
const ThirdTest = () => {
  return (
    <div className='w-full h-[300vh] justify-between bg-[#AEDEE0] flex items-start px-10'>
               <div className='w-[41.9%] mt-20 pt-32 sticky top-0'>
                           ...
                           <div className='w-[35%] h-[50px] mt-6 border font-semibold uppercase flex items-center gap-2 text-[15px] tracking-tight f4 justify-center'>
