    ...
    <div className='w-full relative text-[#EEE9CC] h-[110vh] bg-[#1E1915]'>
      ...
      <div className='w-full h-full'>
        ...
        <div className='w-full h-[23%] overflow-hidden relative bg-red-50'>
          <div ref={testRef} className='scale-100 bg-red-400 relative z-30'>

          <img ref={setimgRef(0)} className='w-full h-[110vh] scale-100 object-cover  trsni' style={{objectPosition:img.first}} src={img.img} alt="not showing" />
          </div>
