  ...
  return (
    <div className='w-full h-[280vh] justify-between bg-[#AEDEE0] flex items-start px-12'>
               ...
               <div className='w-[50%]   h-full pt-[90vh] pl-12'>
                              <div className=' w-[77%] origin-center ml-3  transition-all  pt-4  flex justify-between gap-4 px-10 border border-black h-[15.5%]'>
...
<path d="M4 26H60" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                              ...
                              <div className=' w-[77%] mt-8 origin-center ml-3  transition-all  pt-4  flex justify-between gap-4 px-10 border border-black h-[13.5%]'>
