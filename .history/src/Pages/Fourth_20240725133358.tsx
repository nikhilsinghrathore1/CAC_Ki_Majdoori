    ...
    <div className='w-full h-[400vh] '>
               <div className='w-full flex flex-nowrap  h-[100vh] sticky top-0 '>
                              ...
                              <div className='w-full flex justify-start b h-[30%] pl-10'>
                                             ...
                                             <div className='w-[15rem] h-[15rem] absolute top-[50%] '>
                                                                           <img className='w-full h-full object-cover' src="https://cdn.prod.website-files.com/659dbdfd5a080be…483164/65ea1b841fcd9f50115dbe9c_RocketLaunch.webp" alt="not showing" />
                                             </div>
                              </div>
