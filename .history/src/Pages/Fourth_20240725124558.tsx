               ...
               <div className='w-full flex flex-nowrap  h-[100vh] sticky top-0 '>
                              ...
                              <div className='w-full h-full relative  flex-shrink-0 p-10'>
                                             ...
                                             <div className='w-full h-[70%] pl-40'>
                                                            ...
                                                            <div className=' text-center text-[3rem] w-[80%] font f3 leading-[3.5rem]'> <p>Real people — real lives — we have built products and solutions for.</p></div>
                                             </div>
                              ...
                              <div className='w-full flex justify-start b h-[30%] pl-10'>
                                                            <p className='w-[20%] text-[17px] tracking-tight leading-[30px]'>Our team is global and diverse, because our individual experiences make us stronger.</p>
                                             </div>
                              </div>
