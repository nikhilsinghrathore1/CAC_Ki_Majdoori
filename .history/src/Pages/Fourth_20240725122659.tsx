               ...
               <div className='w-full flex flex-nowrap  h-[100vh] sticky top-0 '>
                              ...
                              <div className='w-full h-full  flex-shrink-0 p-10'>
                                             <div className='w-full flex justify-start b h-[30%] pl-10'>
                                                            <p className='w-[20%] text-[17px] leading-[30px] leading-none '>We’re on a mission to impact as many lives as possible and build a better company while we do it. Here’s our progress.</p>
                                             </div>
                                             <div className='w-full h-[70%]'>
                                                            <div className='text-[10rem] text-center w-[70%] font-semibold f5'>20.4M</div>
                                                            <div className=' text-center text-[3rem] bg-red-400 w-[70%] font f3 leading-[3.5rem]'> <p>Real people — real lives — we have built products and solutions for.</p></div>
                                             </div>
