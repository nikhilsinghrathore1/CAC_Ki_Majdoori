  ...
  return (
    <div className='w-full h-[300vh] justify-between bg-[#AEDEE0] flex items-start px-12'>
               ...
               <div className='w-[50%]  h-full pt-[80vh] pl-16'>
                              <div className='w-fit   transition-all  pt-4 flex justify-center gap-4 px-10 border border-black h-[12.5%]'>
                                             <div className='w-[75%] h-full'>
                                                            <h1 className='f2 text-[1.3rem] tracking-tight font-semibold'>Driven by Purpose</h1>
                                                            <p className='text-[15px] w-[77%] f4 opacity-80 font-light tracking-tight leading-[22px] mt-3'>We believe technology can dramatically improve the experience of managing health, and — when crafted with empathy, intention, and expertise — impact lives at scale.</p>
                                             </div>
