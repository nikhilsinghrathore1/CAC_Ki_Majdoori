    ...
    <div className='w-full h-full absolute z-30 top-0'>
      {/* this is the first container */}
        ...
        <div className='w-1/2  flex items-center text-[#cacaf6] text-[10rem]  mt-[53px] font-light leading-none f1 h-[30%]  '>
          ...
          <div ref={(ele)=>(overlay.current[ele] = ele)} className='absolute z-10 top-[0%] bg-black  h-full w-full left-0'/>
        ...
        <div ref={(el)=>(overlay.current[el] = el)} className='absolute z-10 top-0 bg-black h-full w-full left-0'/>
        ...
        >
          ...
          <div  ref={(el)=>(overlay.current[el] = el)} className='absolute z-10 top-0 bg-black h-full w-full left-0'></div>
