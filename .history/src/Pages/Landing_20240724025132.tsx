...
const Landing = () => {
  ...
  const [img, setimg] = useState(image[0].img)
    ...
    <div className='w-full relative text-[#EEE9CC] h-[110vh] bg-[#1E1915]'>
      ...
      <div className='w-full h-full'>
        ...
        <div className='w-full h-[23%] overflow-hidden relative bg-red-50'>
          <img className='w-full h-[110vh] object-cover scale-[100%] .trsni' style={{objectPosition:image[0].first}} src={img} alt="not showing" />
        ...
        <div className='w-full h-[22.5%] relative overflow-hidden'>
          <img className='w-full h-[110vh] scale-[100%] origin-center transi object-cover' style={{objectPosition:"50% 107.9% "}} src={img} alt="not showing" />
          <div className='w-full h-full bg-black/30 absolute top-[0%] '></div>
        </div>

        <div className='w-full h-[22.9%] relative overflow-hidden'>
          <img className='w-full h-[110vh] object-cover' style={{objectPosition:"50% 165%"}} src={img} alt="not showing" />
          <div className='w-full h-full absolute bg-black/30 top-[0%] '></div>
        </div>

        <div className='w-full h-[22.7%] relative overflow-hidden'>
          <img className='w-full h-[110vh] object-cover' style={{objectPosition:"50% 222%"}} src={img} alt="not showing" />
          <div className='w-full h-full bg-black/30 absolute top-[0%] '></div>
        </div>
