    ...
    <div className='w-full h-full absolute z-30 top-0'>
      {/* this is the first container */}
        ...
        <div className='w-1/2  flex items-center text-[#cacaf6] text-[10rem]  mt-[53px] font-light leading-none f1 h-[30%]  '>
          ...
          <div ref={setOverlayRef(0)} className='absolute z-10 top-[0%] bg-black  h-full w-full left-0'/>
        ...
        <div ref={setOverlayRef(1)} className='absolute z-10 top-0 bg-black h-full w-full left-0'/>
        ...
        >
          ...
          <div ref={setOverlayRef(2)}  className='absolute z-10 top-0 bg-black h-full w-full left-0'></div>
        ...
        <div className='w-full border-b border-[1px] pr-5 pl-8  border-[#EEE9CC] h-[25vh] flex items-start justify-between relative'>
          ...
          <h1 className='capitalize text-[10.5rem] font-light leading-none f1'>Graphiste</h1>
              <div ref={setOverlayRef(3)} className='absolute z-10 top-0 bg-black h-full w-full left-0'/>
        </div>
    </div>
