    ...
    <div className='w-full h-[400vh] '>
               <div className='w-full flex flex-nowrap  h-[100vh] sticky top-0 '>
                              ...
                              <div className='w-full h-full relative  flex-shrink-0 p-10'>
                                             ...
                                             <div className='w-full h-[70%] pl-20'>
                                                            <div className='text-[10rem] text-center w-[70%] leading-none font-semibold f5'>20.4M</div>
                                                            <div className=' text-center text-[3rem] w-[70%] font f3 leading-[3.5rem]'> <p>Real people — real lives — we have built products and solutions for.</p></div>
                                             </div>

                                             <div className='w-[10rem] h-[10rem] bg-red-800 rounded-full absolute top-[68%] left-[20%]'></div>
