  ...
  return (
    <div className='w-full h-[400vh] '>
               <div className='w-full flex flex-nowrap  h-[100vh] sticky top-0 '>
                              ...
                              <div className='w-full h-full flex items-center justify-center bg-blue-300 flex-shrink-0 relative'>
                                <div className=' w-full h-[90%] pt-32 text-center flex flex-col items-center'>
                                  ...
                                  <div className='w-[10rem] h-[10rem] rounded-full absolute -top-20 left-32 bg-red-600'> </div>
                                  <div className='w-[20rem] h-[20rem] rounded-full absolute -bottom-[30%] left-[30%] bg-red-600'> </div>
