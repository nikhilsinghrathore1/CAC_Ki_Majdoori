...
const Sixth = () => {
  return (
    <div className='w-full flex flex-col items-center justify-start h-[70vh]'>
                                             ...
                                             <p className=' w-[70%] text-center text-[1.3rem] leading-[2.1rem] f4'>Working with the Significo team has been such a pleasure! We took on a significant project to rebuild our entire platform and the team approached the project with our best interests in mind. They continue to prioritize the end user experience and offer amazing expertise in all the areas we lack internally. i would personally be lost without this team, thier ability to problem solve, thier openness to feedback and desire to build the product like it is thier own. Miranda Ernst Product Manager @ HealthCheck360</p>

                                             <div className=' flex flex-col items-center mt-10 gap-2 justify-center'>
                                                            <div className='w-[6rem] h-[6rem] rounded-full bg-red-500'></div>
                                                            <p>Miranda Ernst</p>
                                                            <p>product Manager @ HealthCheck360</p>
                                             </div>
