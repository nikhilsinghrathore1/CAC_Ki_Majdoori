...
useEffect(() => {
  ...
  return (
    <div ref={mainCont} className='w-full  h-[250vh] justify-between bg-[#AEDEE0] flex items-start px-12'>
               <div ref={firstCont} className='w-[41.9%] h-[45%]  pt-20 sticky top-0'>
               ...
               <div className='w-[50%]   h-full pt-[85vh] pl-12'>
                              <div className=' w-[77%] origin-center ml-3  transition-all  pt-4  flex justify-between gap-4 px-10 border border-black h-[17.5%]'>
