...
const Landing = () => {
  ...
  useGSAP(()=>{
    ...
    const overlayEffect = ()=>{
      ...
      //   stagger:0.15,
      //   top:0,
      //   onComplete:()=>( setimg((prev) => (prev === image[1] ? image[0] : image[1])))
      //   // opacity:0,
      //   // display:"none"
      // })
      // tl.to(overlayRefs.current,{
    ...
    <div className='w-full relative text-[#EEE9CC] h-[110vh] bg-[#1E1915]'>
      ...
      <div className='w-full h-full'>
        ...
        <div className='w-full h-[23%] overflow-hidden relative bg-red-50'>
          <img ref={setimgRef(0)} className='w-full h-[110vh] object-cover scale-[100%] trsni' style={{objectPosition:img.first}} src={img.img} alt="not showing" />
        ...
        <div className='w-full h-[22.5%] relative overflow-hidden'>
          <img ref={setimgRef(1)} className='w-full h-[110vh] scale-[100%] origin-center transi object-cover' style={{objectPosition:img.second}} src={img.img} alt="not showing" />
          <div className='w-full h-full bg-black/30 absolute top-[0%] '></div>
        </div>
