...
<path d="M28 53.2154L20.4651 51.3317C20.1594 51.2552 19.876 51.1076 19.6381 50.9008L14 46" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                              ...
                              <div className=' w-[77%] mt-10 origin-center ml-3  transition-all  pt-4  flex justify-between gap-4 px-10 border border-black h-[12.5%]'>
                                            <InsideAbout mainText={"Security & Compliance"} para={"Not just technology experts. Health experts. We are able to navigate both stringent regulatory environments and the complexities of technology and data."} svg={}/>
