...
const ThirdTest = () => {
  return (
    <div className='w-full h-[300vh] justify-between bg-[#AEDEE0] flex items-start px-12'>
               ...
               <div className='w-[50%] bg-red-400  h-full pt-[80vh] pl-16'>
                              <div className='w-[77%] origin-center  transition-all  pt-4  flex justify-between gap-4 px-10 border border-black h-[12.5%]'>
