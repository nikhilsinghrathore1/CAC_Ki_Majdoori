    ...
    <div className='w-full h-full absolute z-30 top-0'>
      {/* this is the first container */}
        ...
        <div 
             ...
             className='w-1/2 flex items-center text-red-500 text-[10rem]  mt-12 font-light leading-none f1 h-[30%]  '>
                      <p className=' flex'>
                               C
        ...
        <div   
          ...
          className="w-1/2 text-[11rem] pt-20  flex justify-start pl-20 items-center h-[30%]"
        >
