               ...
               <div className='w-[50%] h-full pt-[80vh] pl-16'>
                              <div className='w-[76%] pt-4 flex px-10 border border-black h-[12.5%]'>
                                             <div className='w-[70%] h-full'>
                                                            ...
                                                            <p className='text-[14px] f4 font-light'>We believe technology can dramatically improve the experience of managing health, and — when crafted with empathy, intention, and expertise — impact lives at scale.</p>
                                             </div>
