  ...
  return (
    ...
    <div className='w-full h-full absolute z-30 top-0'>
      {/* this is the first container */}
        ...
        className='w-full border-b border-[1px] pl-5  pr-40 tracking-wide border-[#EEE9CC] h-[25vh] flex items-start justify-between'>
        <div 
       
             className='w-1/2 flex items-center text-[#cacaf6] text-[10rem]  mt-12 font-light leading-none f1 h-[30%]  '>
                      <p className=' flex'>
                               C
        ...
        <div   
           ...
           className='w-full f1 border-b border-[1px] pr-5 pl-40  border-[#EEE9CC] h-[25vh] flex items-start justify-between'>
          <p className='text-[1.45rem] mt-4 font-light leading-none f1'>Design d'objet</p>
          <div
        
          className="w-1/2 text-[#FFA500] text-[11rem] pt-20  flex justify-start pl-20 items-center h-[30%]"
        >
        ...
        onMouseLeave={() => setCircle(false)}
         className='w-full border-b border-[1px] pl-5 pr-[440px]  border-[#EEE9CC] h-[25vh] flex items-start justify-between'>
        <div
          className="w-1/2 f1 flex pt-20 text-[10rem] items-center h-[30%]"
        >
          <p className="flex">
            C
            {"ircle".split("").map((e, i) => (
